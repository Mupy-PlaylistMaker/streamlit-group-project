...
REDIRECT_URI = "https://spotify20app20valentinpy-lmyqmr9pbkmywvv4kssxdg.streamlit.app/"
...
sp_oauth = SpotifyOAuth(
    ...
    scope=SCOPE,
    cache_path=".cache-mupy"  # Optional: keeps token session persistent
)
...
query_params = st.query_params  # ✅ FIXED: removed parentheses
